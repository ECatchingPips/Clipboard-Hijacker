...
$telegram_base = "https://api.telegram.org/bot0000000000:AAGRDjUqixqTmLDCKHD5_hbLCED6OzyEYpo/sendMessage?chat_id=5600000001&text="  # ← Replace with your real bot token and chat_id
